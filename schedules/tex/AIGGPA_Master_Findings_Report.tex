...
\begin{itemize}
  \item \textbf{Significant Cadre Divide:} High-level officials (Class I) report high tool confidence (mean of 4.85/5.00) and receive structured training (84.6\% coverage). Support staff (Class IV) face low confidence (mean of 1.50/5.00), severe UI difficulties (mean difficulty of 4.71/5.00), and negligible training (7.1\% coverage).
