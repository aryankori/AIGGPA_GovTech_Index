...
\fancyhead[L]{\small\textbf{AIGGPA --- Health}}
...
{\large\bfseries Health Department}\\[1pt]
{\hindifont\itshape\color{black!70} स्वास्थ्य विभाग}\\[4pt]
...
\noindent\textbf{Key Digital Tools:} ANMOL MP, HMIS, Nikshay, eVIN, IHIP, Ayushman/ABHA, MPCDSR
...
\newpage
\noindent\rule{\textwidth}{0.3pt}\vspace{3pt}
\noindent{\large\bfseries Section I: Health --- Specific / {\hindifont स्वास्थ्य विभाग विशिष्ट}}\vspace{3pt}

\noindent\begin{tabularx}{\textwidth}{@{}L{0.8cm} X L{5.2cm}@{}}
Q40 & Which Health department digital tools are you aware of? & {\Large$\square$} ANMOL {\Large$\square$} HMIS {\Large$\square$} Nikshay {\Large$\square$} eVIN {\Large$\square$} IHIP {\Large$\square$} ABHA {\Large$\square$} MPCDSR {\Large$\square$} None \\
 & {\hindifont\small\itshape\color{black!70} स्वास्थ्य विभाग के कौन-से डिजिटल उपकरणों से आप अवगत हैं?} & \\[3pt]
Q41 & Has ANMOL MP or ABHA improved your ability to track patients? & \likert \\
 & {\hindifont\small\itshape\color{black!70} क्या ANMOL या ABHA ने मरीज़ ट्रैकिंग में सुधार किया है?} & \\[3pt]
Q42 & How often do you enter the SAME data in both paper AND digital? & \likert{} {\scriptsize(1=Never, 5=Always)} \\
 & {\hindifont\small\itshape\color{black!70} कितनी बार आप एक ही डेटा कागज़ और डिजिटल दोनों में दर्ज करते हैं?} & \\[3pt]
Q43 & How reliably does eVIN reflect actual vaccine stock? & \likert{} {\scriptsize(1=Unreliable, 5=Reliable)} \\
 & {\hindifont\small\itshape\color{black!70} eVIN वास्तविक टीका स्टॉक को कितनी विश्वसनीयता से दर्शाता है?} & \\[3pt]
Q44 & How much does mandatory IHIP disease reporting add to your workload? & \likert{} {\scriptsize(1=None, 5=Significant)} \\
 & {\hindifont\small\itshape\color{black!70} अनिवार्य IHIP रोग रिपोर्टिंग आपके कार्यभार में कितना जोड़ती है?} & \\[3pt]
Q45 & When registering a pregnant woman for ANC, which steps are on ANMOL? & ANMOL: \rule{5cm}{0.4pt}\\[2pt] && Paper: \rule{5cm}{0.4pt} \\
 & {\hindifont\small\itshape\color{black!70} गर्भवती महिला का ANC पंजीकरण करते समय कौन-से चरण ANMOL पर हैं?} & \\[3pt]
Q46 & For Nikshay: do you enter case notifications yourself? & {\Large$\square$} I enter {\Large$\square$} DEO {\Large$\square$} District {\Large$\square$} Don't use {\Large$\square$} N/A \\
 & {\hindifont\small\itshape\color{black!70} निक्षय के लिए: क्या आप स्वयं केस अधिसूचना दर्ज करते हैं?} & \\[3pt]
Q47 & When there is a disease outbreak, how do you report it? & {\Large$\square$} IHIP immediately {\Large$\square$} Phone BMO {\Large$\square$} Paper to CMHO {\Large$\square$} WhatsApp {\Large$\square$} Multiple \\
 & {\hindifont\small\itshape\color{black!70} जब कोई रोग प्रकोप होता है, तो आप इसकी रिपोर्ट कैसे करते हैं?} & \\[3pt]
Q48 & What is the single biggest problem with health portals? & \rule{\linewidth}{0.4pt}\\[2pt] && \rule{\linewidth}{0.4pt} \\
 & {\hindifont\small\itshape\color{black!70} स्वास्थ्य पोर्टलों की सबसे बड़ी समस्या क्या है?} & \\[3pt]
Q49 & Does the BMO/CMHO review the data you upload? & {\Large$\square$} Reviews regularly {\Large$\square$} Sometimes {\Large$\square$} Only inspections {\Large$\square$} Never {\Large$\square$} Don't know \\
 & {\hindifont\small\itshape\color{black!70} क्या BMO/CMHO आपके द्वारा अपलोड किए गए डेटा की समीक्षा करता है?} & \\[3pt]
\end{tabularx}
\vspace{3pt}
\noindent\rule{\textwidth}{0.3pt}\vspace{3pt}
