...
\fancyhead[L]{\small\textbf{AIGGPA --- Forest}}
...
{\large\bfseries Forest Department}\\[1pt]
{\hindifont\itshape\color{black!70} वन विभाग}\\[4pt]
...
\noindent\textbf{Key Digital Tools:} e-Green Watch (CAMPA), AI Forest Alert, GIS/Remote Sensing, Forest Offence MIS, Nursery MIS
...
\newpage
\noindent\rule{\textwidth}{0.3pt}\vspace{3pt}
\noindent{\large\bfseries Section I: Forest --- Specific / {\hindifont वन विभाग विशिष्ट}}\vspace{3pt}

\noindent\begin{tabularx}{\textwidth}{@{}L{0.8cm} X L{5.2cm}@{}}
Q40 & Which Forest department digital tools are you aware of? & {\Large$\square$} e-Green Watch {\Large$\square$} AI Alert {\Large$\square$} GIS/Remote Sensing {\Large$\square$} Offence MIS {\Large$\square$} Nursery MIS {\Large$\square$} None \\
 & {\hindifont\small\itshape\color{black!70} वन विभाग के कौन-से डिजिटल उपकरणों से आप अवगत हैं?} & \\[3pt]
Q41 & Has the AI alert system improved detection of illegal activity? & \likert{}\quad{\Large$\square$} N/A \\
 & {\hindifont\small\itshape\color{black!70} क्या AI अलर्ट प्रणाली ने अवैध गतिविधि की पहचान में सुधार किया है?} & \\[3pt]
Q42 & How difficult do you find GIS tools? & \likert{} {\scriptsize(1=Easy, 5=Difficult)} \\
 & {\hindifont\small\itshape\color{black!70} GIS उपकरण आपको कितने कठिन लगते हैं?} & \\[3pt]
Q43 & Do you have a GPS-enabled device for field verification? & {\Large$\square$} Dept-issued {\Large$\square$} Personal phone {\Large$\square$} Not available \\
 & {\hindifont\small\itshape\color{black!70} क्या आपके पास क्षेत्र सत्यापन के लिए GPS उपकरण है?} & \\[3pt]
Q44 & How often does poor network prevent digital tool use in the field? & \likert{} {\scriptsize(1=Never, 5=Always)} \\
 & {\hindifont\small\itshape\color{black!70} खराब नेटवर्क कितनी बार क्षेत्र में डिजिटल उपकरण उपयोग रोकता है?} & \\[3pt]
Q45 & When you receive an AI alert, what do you do step by step? & \rule{\linewidth}{0.4pt}\\[2pt] && \rule{\linewidth}{0.4pt} \\
 & {\hindifont\small\itshape\color{black!70} जब आपको AI अलर्ट मिलता है, तो आप क्या करते हैं?} & \\[3pt]
Q46 & When filing a Forest Offence report, which parts are digital? & Digital: \rule{5cm}{0.4pt}\\[2pt] && Paper: \rule{5cm}{0.4pt} \\
 & {\hindifont\small\itshape\color{black!70} वन अपराध रिपोर्ट दर्ज करते समय कौन-से भाग डिजिटल हैं?} & \\[3pt]
Q47 & Have you received training on GIS, GPS, or the AI alert system? & {\Large$\square$} Formal training {\Large$\square$} From colleague {\Large$\square$} Self-taught {\Large$\square$} No training \\
 & {\hindifont\small\itshape\color{black!70} क्या आपको GIS, GPS, या AI अलर्ट प्रणाली पर प्रशिक्षण मिला है?} & \\[3pt]
Q48 & What is the biggest challenge in using digital tools in the field? & \rule{\linewidth}{0.4pt}\\[2pt] && \rule{\linewidth}{0.4pt} \\
 & {\hindifont\small\itshape\color{black!70} क्षेत्र में डिजिटल उपकरणों के उपयोग में सबसे बड़ी चुनौती क्या है?} & \\[3pt]
Q49 & Does your DFO/ACF personally review alerts and GIS data? & {\Large$\square$} Reviews personally {\Large$\square$} Delegates {\Large$\square$} Mixed {\Large$\square$} Don't know \\
 & {\hindifont\small\itshape\color{black!70} क्या आपके DFO/ACF व्यक्तिगत रूप से अलर्ट और GIS डेटा की समीक्षा करते हैं?} & \\[3pt]
\end{tabularx}
\vspace{3pt}
\noindent\rule{\textwidth}{0.3pt}\vspace{3pt}
