...
\fancyhead[L]{\small\textbf{AIGGPA --- Revenue}}
...
{\large\bfseries Revenue Department}\\[1pt]
{\hindifont\itshape\color{black!70} राजस्व विभाग}\\[4pt]
...
\noindent\textbf{Key Digital Tools:} MP Bhulekh / WebGIS 2.0, RCMS, SAARA, SAMPADA 2.0, e-Court
...
\newpage
\noindent\rule{\textwidth}{0.3pt}\vspace{3pt}
\noindent{\large\bfseries Section I: Revenue --- Specific / {\hindifont राजस्व विभाग विशिष्ट}}\vspace{3pt}

\noindent\begin{tabularx}{\textwidth}{@{}L{0.8cm} X L{5.2cm}@{}}
Q40 & Which Revenue digital tools are you aware of? & {\Large$\square$} Bhulekh/WebGIS {\Large$\square$} RCMS {\Large$\square$} SAARA {\Large$\square$} SAMPADA 2.0 {\Large$\square$} e-Court {\Large$\square$} None \\
...
Q45 & When you process a mutation case, which steps are digital and which on paper? & Digital: \rule{5cm}{0.4pt}\\[2pt] && Paper: \rule{5cm}{0.4pt} \\
 & {\hindifont\small\itshape\color{black!70} दाखिल-खारिज प्रक्रिया में कौन-से चरण डिजिटल और कौन-से कागज़ पर हैं?} & \\[3pt]
Q46 & Has SAMPADA 2.0 reduced property registration time? & {\Large$\square$} Much faster {\Large$\square$} Somewhat {\Large$\square$} No change {\Large$\square$} Slower {\Large$\square$} Don't use \\
 & {\hindifont\small\itshape\color{black!70} क्या SAMPADA 2.0 ने संपत्ति पंजीकरण का समय कम किया है?} & \\[3pt]
Q47 & How often does Bhulekh/WebGIS show errors or timeouts? & {\Large$\square$} Never {\Large$\square$} Rarely {\Large$\square$} Sometimes {\Large$\square$} Often {\Large$\square$} Always \\
 & {\hindifont\small\itshape\color{black!70} भूलेख/WebGIS में कितनी बार त्रुटि या टाइमआउट आता है?} & \\[3pt]
Q48 & What is the biggest obstacle to completing Khasra/B-1 updates digitally? & \rule{\linewidth}{0.4pt}\\[2pt] && \rule{\linewidth}{0.4pt} \\
 & {\hindifont\small\itshape\color{black!70} खसरा/B-1 अपडेट डिजिटल रूप से पूरा करने में सबसे बड़ी बाधा क्या है?} & \\[3pt]
Q49 & Do you receive different digital tasks based on your post? & {\Large$\square$} Yes, separated {\Large$\square$} Somewhat {\Large$\square$} No, same {\Large$\square$} Don't know \\
 & {\hindifont\small\itshape\color{black!70} क्या आपको अपने पद के अनुसार अलग-अलग डिजिटल कार्य मिलते हैं?} & \\[3pt]
\end{tabularx}
\vspace{3pt}
\noindent\rule{\textwidth}{0.3pt}\vspace{3pt}
