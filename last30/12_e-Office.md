...
⚠️  This run was called BARE on a named-entity topic ("e-Office"):
...
### 1. Digg cluster about e-office (score 43, 1 item, sources: Digg)
1. [digg] Digg cluster about e-office
   - 2026-06-14 | Digg | [8posts, 5auth] | score:43 | fun:55
   - URL: https://di.gg/ai/mock1abc
   - Evidence: Curated cluster summarizing recent e-office discussion across the AI 1000.
   - [@exampledev](https://x.com/exampledev/status/1) via Digg: Quote from the AI 1000 about e-office.

### 2. People on X are discussing e-office right now. (score 38, 1 item, sources: X)
1. [x] People on X are discussing e-office right now.
   - 2026-06-15 | @example | [200likes, 35rt, 18re] | score:38 | fun:56
   - URL: https://x.com/example/status/1
   - Evidence: People on X are discussing e-office right now.

### 3. e-office discussion thread (score 35, 1 item, sources: Reddit)
1. [reddit] e-office discussion thread
...
### 4. e-office article (score 35, 1 item, sources: Web)
1. [grounding] e-office article
   - 2026-06-10 | example.com | score:35
   - URL: https://example.com/article
   - Evidence: Recent web reporting about e-office.

## Stats

- Total evidence: 4 items across 4 sources
...
then rerun `/last30days e-Office`. The skill will resolve handles
...
└─ 📎 Raw results saved to ~/OneDrive/Documents/Visual Studio 2022/AIGGPA_Report/last30/12_e-Office.md
---
